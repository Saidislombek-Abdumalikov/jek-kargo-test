  ...
  return (
    <div className="space-y-5 pb-6 animate-fade-in">
      ...
      <div className="flex justify-between items-center px-1 pt-2">
        <div>
          <p className="text-text-secondary text-xs font-bold uppercase tracking-wide mb-0.5">Xush kelibsiz,</p>
          <h1 className="text-3xl font-black text-text tracking-tight">{firstName} 👋</h1>
        </div>
        <button 
          onClick={() => onNavigate(Tab.PROFILE)}
          className="w-11 h-11 bg-white rounded-2xl shadow-soft flex items-center justify-center text-primary font-bold text-lg border border-gray-50 active:scale-95 transition-transform"
        >
          {firstName.charAt(0)}
        </button>
      </div>
      ...
      <div 
        ...
        className="w-full relative overflow-hidden bg-gradient-to-br from-[#0066CC] to-[#004499] rounded-[32px] p-6 text-white shadow-xl shadow-blue-900/20 group cursor-pointer active:scale-[0.98] transition-all hover:shadow-2xl hover:shadow-blue-900/30"
      >
        ...
        <div className="relative z-10">
          <div className="flex justify-between items-start mb-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                 <span className="block font-bold leading-none text-white/90">JEK ID</span>
                 <span className="text-[10px] text-blue-200 font-medium">Shaxsiy Raqam</span>
              </div>
            </div>
            <div className="bg-white/20 backdrop-blur-md px-3 py-1.5 rounded-xl text-[10px] font-bold border border-white/10 group-hover:bg-white/30 transition-colors uppercase tracking-wider flex items-center gap-1.5">
              <span>🇨🇳</span> Xitoy Ombori
            </div>
          </div>

          <div className="mb-5 text-center sm:text-left">
            <p className="text-blue-200/80 text-[10px] font-bold uppercase tracking-[0.2em] mb-1">Mening ID Raqamim</p>
            <p className="text-4xl font-mono font-black tracking-widest text-shadow-sm">{clientId.replace(/^(JEK|JK|TT|TOP)/, '')}</p>
          </div>
      ...
      {/* Live Status Widget */}
      <div>
        <h3 className="text-text font-black text-lg mb-3 px-1">Yuklar Holati</h3>
        <div 
            onClick={() => onNavigate(Tab.MY_PARCELS)}
            className="bg-white p-5 rounded-[28px] shadow-soft border border-gray-50 flex items-center justify-between cursor-pointer active:scale-[0.98] transition-all hover:border-primary/20"
        >
            <div className="flex gap-8">
                <div className="flex flex-col">
                    ...
                    <span className="text-[10px] font-bold text-gray-400 uppercase tracking-wide mt-1">Kelgan</span>
                </div>
                ...
                <div className="flex flex-col">
                    ...
                    <span className="text-[10px] font-bold text-gray-400 uppercase tracking-wide mt-1">Yo'lda</span>
                </div>
            </div>
      ...
      <div className="grid grid-cols-2 gap-3">
          <a 
            ...
            className="bg-white p-5 rounded-[24px] shadow-soft border border-gray-50 flex flex-col items-start gap-4 active:scale-95 transition-all hover:bg-gray-50"
          >
            <div className="w-11 h-11 bg-blue-50 rounded-2xl flex items-center justify-center text-primary">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" /></svg>
            </div>
            <div className="text-left">
              <p className="font-bold text-text text-sm">Admin</p>
              <p className="text-[10px] text-text-secondary font-medium">Yordam so'rash</p>
            </div>
          </a>

          <div 
             onClick={() => onNavigate(Tab.CALCULATOR)}
             className="bg-white p-5 rounded-[24px] shadow-soft border border-gray-50 flex flex-col items-start gap-4 active:scale-95 transition-all hover:bg-gray-50 cursor-pointer"
          >
            ...
            <div className="text-left">
              <p className="font-bold text-text text-sm">Hisoblash</p>
              <p className="text-[10px] text-text-secondary font-medium">Narx kalkulyatori</p>
            </div>
          </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <button 
          ...
          className="bg-white p-4 rounded-[24px] shadow-soft border border-gray-50 flex items-center gap-3 active:scale-95 transition-transform"
        >
           <div className="w-1 h-8 bg-primary rounded-full"></div>
           <div className="text-left">
              <p className="text-[9px] text-text-secondary font-bold uppercase tracking-wide">Avia Muddat</p>
              <p className="text-lg font-black text-text">{settings.deliveryTime.avia}</p>
           </div>
        </button>
        <button 
        ...
        >
           ...
           <div className="text-left">
              ...
              <p className="text-lg font-black text-text">{settings.deliveryTime.avto}</p>
           </div>
        </button>
      </div>
